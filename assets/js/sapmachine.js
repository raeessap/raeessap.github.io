...
(function (window, document, $, undefined) {
    ...
    $(document).ready(function () {
        ...
        console.log(window.location.origin + '/assets/data/env.json');
        $.getJSON(window.location.origin + '/assets/data/env.json', function onJSONDataReceived(data) {
              console.log(data);
            _jsondata[0] = data;
        });
        ...
        Object.entries(_jsondata[0]['buildfiles']).forEach(([key, value]) => {
            ...
            $.getJSON(window.location.origin + '/' + value['file'], function onJSONDataReceived(data) {
                _jsondata[++i] = data;
            });
        });
